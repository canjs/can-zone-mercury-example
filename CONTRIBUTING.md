...
This section will walk you through setting up the [repository](https://github.com/canjs/mercury-app) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork mercury-app, you can start by going to its [fork page](https://github.com/canjs/mercury-app/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/mercury-app
```
